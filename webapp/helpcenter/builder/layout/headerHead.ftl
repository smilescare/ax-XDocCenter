...
<head>
    ...
    <link href="<@ofbizContentUrl>/hc/assets/page-builder/css/app.css</@ofbizContentUrl>" type="text/css" rel="stylesheet" />

    <#--set Dojo configuration, load Dojo-->
    <link rel="stylesheet" href="//ajax.googleapis.com/ajax/libs/dojo/1.10.4/dijit/themes/claro/claro.css">
    <link href="<@ofbizContentUrl>/hc/assets/page-builder/css/dojo-components/dojo-overrides.css</@ofbizContentUrl>" type="text/css" rel="stylesheet" />
    <script>
        dojoConfig = {
            async: true,
            parseOnLoad: true,
...
//                dialog.set("content", "<pre>" + JSON.stringify(config, null, "\t") + "```");
    ...
    <script type="text/javascript" src="<@ofbizContentUrl>/hc/assets/page-builder/js/app.js</@ofbizContentUrl>"></script>
    <script type="text/javascript" src="<@ofbizContentUrl>/hc/assets/page-builder/js/PageController.js</@ofbizContentUrl>"></script>
...
<div id="axAppLoadingOverlay" class="ax-loadingOverlay ax-pageOverlay">
    <div class="ax-loadCenter">
        <img class="ax-loaderLogo" src="<@ofbizContentUrl>/hc/assets/page-builder/img/logo.png</@ofbizContentUrl>" />
        <p class="ms-font-s-plus">Managing Content Simplified</p>
        <br>
        <img src="<@ofbizContentUrl>/hc/assets/page-builder/img/loader.gif</@ofbizContentUrl>" />
    </div>
</div>
...
<div class="dijitHidden">
    <div data-dojo-type="dijit/Dialog"  id="globalLoadingOverlay" data-dojo-id="globalLoadingOverlay" class="globalLoadingOverlay">
        <div class="dijitDialogPaneContentArea">
            <img class="ax-loaderLogo" src="<@ofbizContentUrl>/hc/assets/img/loader.gif</@ofbizContentUrl>" style="width:100px;"/>
