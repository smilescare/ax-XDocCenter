define("dojoc/XMegaDialog", [
	...
	"dijit/layout/utils",
	"dojo/text!./templates/XMegaDialog.html",
	...
	var _DialogBase = declare("dijit._DialogBase" + (has("dojo-bidi") ? "_NoBidi" : ""), [_TemplatedMixin, _FormMixin, _DialogMixin, _CssStateMixin], {
		...
		resize: function(dim){
			...
			console.log("resize called with : " + dim);
	...
	var Dialog = declare("dojoc.XMegaDialog", [ContentPane, _DialogBase], {
		// summary:
		...
		// example:
		// |	<div data-dojo-type="dojoc/XMegaDialog" data-dojo-props="href: 'test.html'"></div>
		// example:
