...
<html lang="en">
	<head>
		...
		<!-- css -->
		<link href="/xdoc/assets/material/css/base.min.css" rel="stylesheet">
	
		<!-- css for this project -->
		<link href="/xdoc/assets/material/css/project.min.css" rel="stylesheet">
		<!-- material icons -->
		<link href="//fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
		<!-- favicon -->
		
		<!-- syntax highlighter -->
		<script type="text/javascript" src="/xdoc/assets/syntaxhighlighter/scripts/shCore.js"></script>
		<script type="text/javascript" src="/xdoc/assets/syntaxhighlighter/scripts/shBrushJScript.js"></script>
	  	<script src="/xdoc/assets/syntaxhighlighter/scripts/shBrushXml.js" type="text/javascript"></script>
	  	<link type="text/css" rel="stylesheet" href="/xdoc/assets/syntaxhighlighter/styles/shCoreDefault.css"/>
