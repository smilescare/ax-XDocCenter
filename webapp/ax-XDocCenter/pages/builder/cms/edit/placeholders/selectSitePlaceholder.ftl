<div style="text-align:center;margin:0 auto;width:100%;">
	...
	<img src="<@ofbizContentUrl>/xdoc/assets/page-builder/img/DocumentsAndConversations.jpg</@ofbizContentUrl>" style="width:450px;" />
	<div>
		<div data-dojo-type="dijit/form/Button"
			label="Select Website" showLabel="true">
