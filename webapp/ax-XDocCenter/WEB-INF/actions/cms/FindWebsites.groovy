 ...
 *  *  Written by Mandeep Sidhu <mandeep.sidhu@simbacart.com>,  July, 2016                    *
 *  * ****************************************************************************************
 *
 */
...
fieldsToSelectSet = UtilMisc.toSet("webSiteId", "siteName");
...
masterList.each{ masterRecord ->
	...
	String infoText = "Some useful site related information, can grow pretty big as well.";
