...
<input type="submit" class="aui-button aui-button-primary"  class="aui-button aui-button-primary"  class="smallSubmit" name="submitButton" value="${uiLabelMap.CommonQuery}"/>
</td>
